...
const isOutOfStock = product.CountINStock !== undefined && product.CountINStock <= 0;
  ...
  return (
    <Link
      ...
      key={product._id}
      className="rounded-lg overflow-hidden shadow-xl transition-all hover:shadow-2xl hover:-translate-y-1"
    >
      ...
      <img
        ...
        className={`w-[220px] h-[375px] object-cover transition-transform duration-500 `}
      />
